 ...
 *
 * The LeftAlignLongRenderer fixes the previous by aligning Longs on
 * left like String types when presented in a table.
 * @author Milton Smith
 */
public class LeftAlignLongRenderer extends DefaultTableCellRenderer {
    public LeftAlignLongRenderer() {
