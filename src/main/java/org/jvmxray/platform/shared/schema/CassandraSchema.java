...
public class CassandraSchema extends AbstractDatabaseSchema {
    ...
    protected void createIndexes() throws SQLException {
        ...
        try {
            ...
            String createStage0TraceIdIndex = String.format(
                "CREATE INDEX IF NOT EXISTS idx_stage0_trace_id ON %s.%s (%s)",
                databaseName, SchemaConstants.STAGE0_EVENT_TABLE, SchemaConstants.COL_TRACE_ID);
            cqlSession.execute(createStage0TraceIdIndex);
