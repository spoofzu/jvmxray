...
public class TurtleIntegrationTest {
    ...
    private void run(String[] args) {
        try {
            // Initialize integration configuration (sets up logback config and system properties)
            IntegrationInitializer.getInstance();
            
            // Use standard SLF4J LoggerFactory to get logger
