...
//                    "CREATE TABLE IF NOT EXISTS " + KEYSPACE_NAME + "." + EVENT_TBL + " ("
...
//     * @param loggerName Logback logger namespace.  Logging namespace assigned to event.  Example: org.jvmxray.agent.driver.jvmxraysecuritymanager.events.clz.packagedefine
...
//                             String loggerName, String threadName, String aid,
...
//                .value("LOGGERNAME",QueryBuilder.bindMarker())
//                .value("THREADNAME",QueryBuilder.bindMarker())
//                .value("APPLICATIONID",QueryBuilder.bindMarker())
