...
/**
 * Unit tests for McpStdioToRestBridge
 */
public class McpStdioToRestBridgeTest {
    ...
    public void testHelpOption() {
        ...
        try {
            java.lang.reflect.Method parseMethod = McpStdioToRestBridge.class.getDeclaredMethod("parseArguments", String[].class);
