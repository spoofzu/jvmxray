package org.jvmxray.platform.graphql.app;
...
import org.jvmxray.platform.graphql.controller.XRCassandraConnectionFactory;
import org.jvmxray.platform.graphql.resolver.XREventResolver;
...
@WebServlet(name = "XRGraphQLServer", value = "/graphql/*")
public class XRGraphQLServer extends HttpServlet {

    private static Logger logger = LoggerFactory.getLogger("org.jvmxray.platform.graphql.app.XRGraphQLServer");
    ...
    private void initCassandra() throws IOException {
        XRCassandraConnectionFactory controller = XRCassandraConnectionFactory.getInstance();
    ...
    private RuntimeWiring buildWiring() {
        XREventResolver eventResolver = new XREventResolver(session);
