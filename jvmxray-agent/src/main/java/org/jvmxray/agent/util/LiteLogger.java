...
//TODO: Need to remove this class and use SimpleLogger.
    ...
    private LiteLogger() {
        ...
        } else if( rawsetting.equals("ERROR")) {
            this.eLevel = Level.ERROR;
        } else {
    ...
    public final boolean isError() {
        return (this.eLevel == Level.ERROR);
    }

    public final boolean isInfo() {
        return (this.eLevel == Level.INFO) || (this.eLevel == Level.ERROR);
    }

    public final boolean isDebug() {
        return (this.eLevel == Level.DEBUG) || (this.eLevel == Level.INFO) || (this.eLevel == Level.ERROR);
    }
