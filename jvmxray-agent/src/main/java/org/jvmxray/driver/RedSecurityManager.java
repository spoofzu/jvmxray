...
import org.jvmxray.task.QueuedEventLogTask;
...
/**
 * RedSecurityManager conforms to the java.lang.SecurityManager specifications.  This class
 * is loaded dynamically in your Java application through command line options.  It
 * monitors access to protected resources used during runtime and logs them for diagnostics
 * and testing purposes.
 * @author Milton Smith
 */
public class RedSecurityManager extends SecurityManager {
    ...
    private QueuedEventLogTask eventlogger;
    // Events to process.
    ...
    public RedSecurityManager() {
        try {
            ...
            statuslogger.logMessage("RedSecurityManager(CTOR): Initialization complete.");
        }catch(Throwable t){
            System.err.println("RedSecurityManager(CTOR): Error initializing. msg="+t.getMessage());
            t.printStackTrace();
        }
    }
    ...
    private void initialize() throws Exception {
        ...
        eventlogger = new QueuedEventLogTask(p);
